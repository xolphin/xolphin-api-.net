...
namespace XolphinApiDotNet.Requests
{
    public class Request
    {
        ...
        public Request SetApproverRepresentativeFirstName(string approverRepresentativeFirstName)
        {
            ApproverRepresentativeFirstName = approverRepresentativeFirstName;
            return this;
        }

        public Request SetApproverRepresentativeLastName(string approverRepresentativeLastName)
        {
            ApproverRepresentativeLastName = approverRepresentativeLastName;
            return this;
        }

        public Request SetApproverRepresentativeEmail(string approverRepresentativeEmail)
        {
            ApproverRepresentativeEmail = approverRepresentativeEmail;
            return this;
        }

        public Request SetApproverRepresentativePhone(string approverRepresentativePhone)
        {
            ApproverRepresentativePhone = approverRepresentativePhone;
            return this;
        }

        public Request SetApproverRepresentativePosition(string approverRepresentativePosition)
        {
            ApproverRepresentativePosition = approverRepresentativePosition;
            return this;
        }

        public Request SetProvince(string province)
        {
            Province = province;
            return this;
        } 
