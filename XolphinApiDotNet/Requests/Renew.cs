...
namespace XolphinApiDotNet.Requests
{
    public class Renew
    {
        ...
        public Renew SetApproverRepresentativeFirstName(string approverRepresentativeFirstName)
        {
            ApproverRepresentativeFirstName = approverRepresentativeFirstName;
            return this;
        }

        public Renew SetApproverRepresentativeLastName(string approverRepresentativeLastName)
        {
            ApproverRepresentativeLastName = approverRepresentativeLastName;
            return this;
        }

        public Renew SetApproverRepresentativeEmail(string approverRepresentativeEmail)
        {
            ApproverRepresentativeEmail = approverRepresentativeEmail;
            return this;
        }

        public Renew SetApproverRepresentativePhone(string approverRepresentativePhone)
        {
            ApproverRepresentativePhone = approverRepresentativePhone;
            return this;
        }

        public Renew SetApproverRepresentativePosition(string approverRepresentativePosition)
        {
            ApproverRepresentativePosition = approverRepresentativePosition;
            return this;
        }

        public Renew SetProvince(string province)
        {
            Province = province;
            return this;
        } 
        
        public Renew SetCountry(string country)
        {
            Country = country;
            return this;
        }
